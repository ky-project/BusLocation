...
public class newsGetObjectById extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (serviceId==null || serviceId=="") serviceId = "1";  
		PersistenceLayerLiuhx persistenceLayer = (PersistenceLayerLiuhx) ctx.getBean("persistenceLayerLiuhx");
	  	String newsList = persistenceLayer.NewsGetObjectById(Integer.parseInt(serviceId));		
