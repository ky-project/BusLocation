...
public class getMenuList extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//System.out.println(menuLevel);
		if(menuLevel==null) menuLevel="main";
		String menuList = persistenceLayer.findMenuList(menuLevel, fatherId);
		//String menuList = persistenceLayer.findMenuList("main", "1");	
