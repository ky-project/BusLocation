...
public class updateReguBus extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//在数据库中更新对应的数据记录
		String result = persistenceLayer.updateReguBusById(regId,busId, regStart,regEnd,ts,regNote,regContent);
