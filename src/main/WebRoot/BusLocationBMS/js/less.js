...
module.exports = function(options, logger) {
    ...
    var AbstractFileManager = require("../less/environment/abstract-file-manage.js");
...
module.exports = function(window, options) {
    ...
    var environment = less.environment,
        FileManager = require("./file-manage")(options, less.logger),
...
var parseCopyProperties = [
    ...
    'processImports',   // option & context - whether to process imports. if false then imports will not be imported.
                        // Used by the import manage to stop multiple import visitors being created.
    'reference',        // Used to indicate that the contents are imported by reference
    'pluginManager'     // Used as the plugin manage for the session
];
...
module.exports = function(environment) {
    ...
    ImportManager.prototype.push = function (path, tryAppendLessExtension, currentFileInfo, importOptions, callback) {
        ...
        if (!fileManager) {
            fileParsedFunc({ message: "Could not find a file-manage for " + path });
            return;
        }
...
module.exports = function(environment, fileManagers) {
    ...
    var less = {
        ...
        AbstractFileManager: require("./environment/abstract-file-manage"),
        ...
        ImportManager: (ImportManager = require('./import-manage')(environment)),
        render: require("./render")(environment, ParseTree, ImportManager),
        parse: require("./parse")(environment, ParseTree, ImportManager),
        LessError: require('./less-error'),
        transformTree: require('./transform-tree'),
        utils: require('./utils'),
        PluginManager: require('./plugin-manage'),
        logger: require('./logger')
    };
